const TABLE_NAME = 'prog_sig_dia';
const TABLE_TITLE = '📆 Siguiente Programacion';
const MAX_ROWS = 500;
...
function handleError(error, context) {
    ...
    showMessage((error && error.message) ? error.message : 'Ocurrio un error ' + context, 'error');
}
...
async function loadData() {
    ...
    try {
        ...
        renderTable(currentData);
        setStatus('Carga completada: ' + currentData.length + ' registros.', false);
    } catch (error) {
